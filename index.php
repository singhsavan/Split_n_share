...
<body>
	...
	<div id="header">
		<div class="container">
			<h1><a href="#" title="ECOBUSINESS">Split_N_Share<span></span></a></h1>
			<hr />
			<!-- top navigation -->
			<ul id="navigation">
				...
				<li><a href="#" title="Portofolio">Expense_sharing</a></li>
				<li><a href="#" title="Contact">Contact_us</a></li>
			</ul>
			<hr />
			<!-- banner message and building background -->
			<div id="banner">
				Welcome to split and share. we offer solutions for
                                travelling ,daily expenses and much more.
			</div>
			<hr />
		</div>
	</div>
	...
	<div id="main" class="container">
		...
		<div id="leftcolumn">
			...
			<ul class="leftbox borderedlist">
				<li><a href="#" title="Garden Tools">Trips</a></li>
				<li><a href="#" title="Organic Foods">Dining</a></li>
				<li><a href="#" title="Planter Boxes">Projects</a></li>
				<li><a href="#" title="Landscape Services">Room_mates</a></li>
		...
		<div id="rightcolumn">
			<div class="rightbox_wrapper">
				<div class="rightbox">
					<img src="images/product.jpg" alt="Image:product" class="product_image" />
